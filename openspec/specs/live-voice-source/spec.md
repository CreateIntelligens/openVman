# live-voice-source Specification

## Purpose
Defines the voice source selection feature for Live mode, allowing the frontend to choose between Gemini's native audio output and a custom TTS-synthesized audio path.
