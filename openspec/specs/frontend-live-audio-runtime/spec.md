# frontend-live-audio-runtime Specification

## Purpose
Defines the browser-side live runtime for ASR capture, turn detection, WebSocket event handling, and audio-driven playback.
