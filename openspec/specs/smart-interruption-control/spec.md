# smart-interruption-control Specification

## Purpose
Defines how interruption is classified, how control signals differ from formal user input, and how active audio/Brain generation is stopped safely.
