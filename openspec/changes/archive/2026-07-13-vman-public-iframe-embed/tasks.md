...
- [x] 8.1 新增 `docs/guides/avatar-embed/README.md`：嵌入步驟、API Key 申請、Web Component API 與 postMessage 事件表
- [x] 8.2 在 `docs/guides/avatar-embed/README.md` 提供公開錯誤碼與排錯指南
...
- [x] 10.3 在 `docs/guides/avatar-embed/README.md` 標註「形象授權限制 / 適用範圍」段落
