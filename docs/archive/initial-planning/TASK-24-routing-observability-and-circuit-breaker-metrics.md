...
| 來源 | 內容 |
|------|------|
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L200) | Spec 已要求 fallback 失敗原因記入 metrics 與 structured logs |
...
| [TASK-22-llm-key-pool-manager-and-quota-aware-routing.md](TASK-22-llm-key-pool-manager-and-quota-aware-routing.md#L1) | task22 已規劃 key pool health / cooldown |
| [TASK-23-model-and-provider-fallback-chain-execution.md](TASK-23-model-and-provider-fallback-chain-execution.md#L1) | task23 已規劃 bounded model/provider fallback chain |
...
| `docs/archive/initial-planning/TASK-24-routing-observability-and-circuit-breaker-metrics.md` | 新增 | 計畫書（本文件） |
