...
| 來源 | 內容 |
|------|------|
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L185) | 已要求同 provider 多 key fallback |
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L186) | 已要求同 provider 多 model fallback |
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L187) | 已要求跨 provider fallback |
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L200) | 已要求同一次對話綁定在同一條 fallback chain |
...
| `docs/archive/initial-planning/TASK-23-model-and-provider-fallback-chain-execution.md` | 新增 | 計畫書（本文件） |
