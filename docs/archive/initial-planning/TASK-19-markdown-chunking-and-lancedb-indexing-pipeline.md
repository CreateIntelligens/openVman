...
| 來源 | 內容 |
|------|------|
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L89) | 已明確要求將 Markdown 知識庫索引到 LanceDB |
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L102) | 每個 chunk 必須帶 `source_file`、`heading`、`date`、`chunk_index` 等 metadata |
...
| `docs/archive/initial-planning/TASK-19-markdown-chunking-and-lancedb-indexing-pipeline.md` | 新增 | 計畫書（本文件） |
