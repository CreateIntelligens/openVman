...
| 來源 | 內容 |
|------|------|
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L182) | Brain 必須內建金鑰與模型回退機制 |
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L185) | 已要求同 provider 多 key fallback |
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L188) | 已要求限流 / quota exceeded 時自動切換 |
...
| `docs/archive/initial-planning/TASK-22-llm-key-pool-manager-and-quota-aware-routing.md` | 新增 | 計畫書（本文件） |
