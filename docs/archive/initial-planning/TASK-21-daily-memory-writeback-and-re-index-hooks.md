...
| 來源 | 內容 |
|------|------|
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L243) | Spec 已要求把當日摘要寫入 `memory/YYYY-MM-DD.md` 並重建 `memories` 表 |
...
| `docs/archive/initial-planning/TASK-21-daily-memory-writeback-and-re-index-hooks.md` | 新增 | 計畫書（本文件） |
