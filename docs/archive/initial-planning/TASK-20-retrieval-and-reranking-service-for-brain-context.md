...
| 來源 | 內容 |
|------|------|
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L114) | Brain 需從 LanceDB `knowledge` / `memories` 取 Top-K context |
| [03_BRAIN_SPEC.md](../../specs/03_BRAIN_SPEC.md#L139) | Spec 已提供 knowledge + memories 檢索概念 |
...
| `docs/archive/initial-planning/TASK-20-retrieval-and-reranking-service-for-brain-context.md` | 新增 | 計畫書（本文件） |
