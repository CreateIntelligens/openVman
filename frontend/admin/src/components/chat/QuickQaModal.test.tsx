...
describe("QuickQaModal", () => {
  it("shows a short question and sends the topic with that question", () => {
    const onClose = vi.fn();
    ...
    expect(questionButton.textContent).not.toContain("痛風");

    fireEvent.click(questionButton);

    expect(onSelectQuestion).toHaveBeenCalledWith("痛風 如何預防");
