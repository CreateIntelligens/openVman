    ...
    <header className="shrink-0 flex items-center justify-between px-6 py-4 border-b border-primary/10 bg-white dark:bg-background-dark/80 backdrop-blur-md z-10 w-full h-[73px]">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-sm transition-colors md:hidden lg:flex ${panelOpen ? "bg-primary/10 border-primary/30 text-primary" : "border-slate-200 dark:border-slate-700/50 text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-900/30 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/50 hover:border-slate-300 dark:hover:border-slate-600"
            }`}
        >
