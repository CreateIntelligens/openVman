        ...
        <div className="flex-1 min-h-0 relative mb-4 rounded-xl border border-slate-800/50 bg-slate-950/30 overflow-hidden shadow-inner flex">
          ...
          {editorMode === "edit" || editorMode === "split" ? (
            <textarea
              ...
              className={`h-full w-full bg-transparent p-5 text-sm leading-7 text-slate-200 placeholder:text-slate-600 focus:outline-none font-mono resize-none overflow-y-auto ${
